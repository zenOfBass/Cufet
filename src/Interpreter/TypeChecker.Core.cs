...
public sealed partial class TypeChecker
{
        ...
        switch (stmt)
        {
            ...
            case CastStatement cs:
            {
                ...
                // does.
                         ...
                         && cs.Function is VariableReference csFreeVr && cs.Args.Count > 0
                         && MemberOwnerType(InferType(cs.Args[0])) is ObjectType csFreeOwner)
                    cs.ResolvedFunctionName = InstantiateMethod(
                        csFreeOwner, csFreeVr.Name, [.. cs.Args.Skip(1)], cs.Line, cs.Column);
    ...
    internal static string FormatType(CufetType type) => type switch
    {
        ...
        SetType st                           => $"set of {FormatType(st.ElementType)}",
        MappingType                          => "mapping",
    ...
    private static string FormatTypePlural(CufetType type) => type switch
    {
        ...
        SetType st                           => $"sets of {FormatType(st.ElementType)}",
